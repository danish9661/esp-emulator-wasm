...
## 🚀 How it Works
When a user toggles the **"Private IoT Gateway"** in the OpenHW Studio UI, the simulated ESP32 stops routing its raw 802.11 Wi-Fi frames to the public cloud. Instead, it forwards them over a WebSocket (`ws://localhost:5095`) directly to this script running on your local machine.
...
```
*Users just double-click this `.exe` and the gateway starts instantly on port 5095.*
